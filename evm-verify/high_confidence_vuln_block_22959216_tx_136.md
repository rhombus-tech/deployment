# HIGH-CONFIDENCE Vulnerability Report - Block 22959216 Transaction 136

## Contract Information
- **Analysis Mode**: High-Confidence Only
- **Protocol**: High-Confidence Analysis
- **Contract Address**: 0x359a77e51315524b12e5884d86c31d841f4c7f08
- **Block Number**: 22959216
- **Transaction Index**: 136
...
- **Description**: Unchecked external call at position 159. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls

### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 927. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls
