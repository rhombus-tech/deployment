/// Selfdestruct Refund Detector
/// Selfdestruct refund exploitation
use crate::bytecode::SecurityFinding;

pub struct SelfdestructRefundDetector {
    bytecode: Vec<u8>,
}

impl SelfdestructRefundDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Selfdestruct refund exploitation at PC {}", location),
                pc: location,
                confidence: 0.83,
            });
        }
