/// Snapshot Voting Gaming Detector
use crate::bytecode::SecurityFinding;

pub struct SnapshotVotingGamingDetector {
    bytecode: Vec<u8>,
}

impl SnapshotVotingGamingDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_exploit_pattern() {
            findings.push(SecurityFinding {
                ...
                description: format!("Snapshot governance gaming at PC {}", location),
                pc: location,
                confidence: 0.84,
            });
        }
