/// Eigenlayer Delegation Detector
use crate::bytecode::SecurityFinding;

pub struct EigenlayerDelegationDetector {
    bytecode: Vec<u8>,
}

impl EigenlayerDelegationDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_exploit_pattern() {
            findings.push(SecurityFinding {
                ...
                description: format!("EigenLayer delegation exploit at PC {}", location),
                pc: location,
                confidence: 0.87,
            });
        }
