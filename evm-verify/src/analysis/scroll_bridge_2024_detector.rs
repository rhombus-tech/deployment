/// Scroll Bridge 2024 Detector
use crate::bytecode::SecurityFinding;

pub struct ScrollBridge2024Detector {
    bytecode: Vec<u8>,
}

impl ScrollBridge2024Detector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_exploit_pattern() {
            findings.push(SecurityFinding {
                ...
                description: format!("Scroll bridge 2024 vulnerability at PC {}", location),
                pc: location,
                confidence: 0.89,
            });
        }
