/// Erc2612 Deadline Check Detector
use crate::bytecode::SecurityFinding;

pub struct Erc2612DeadlineCheckDetector {
    bytecode: Vec<u8>,
}

impl Erc2612DeadlineCheckDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("ERC2612 deadline not validated at PC {}", location),
                pc: location,
                confidence: 0.85,
            });
        }
