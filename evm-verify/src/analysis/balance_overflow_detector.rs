/// Balance Overflow Detector
/// Balance overflow wraps around enabling infinite tokens
use crate::bytecode::SecurityFinding;

pub struct BalanceOverflowDetector {
    bytecode: Vec<u8>,
}

impl BalanceOverflowDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Balance overflow wraps around enabling infinite tokens at PC {}", location),
                pc: location,
                confidence: 0.89,
            });
        }
