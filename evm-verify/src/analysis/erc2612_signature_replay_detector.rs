/// Erc2612 Signature Replay Detector
use crate::bytecode::SecurityFinding;

pub struct Erc2612SignatureReplayDetector {
    bytecode: Vec<u8>,
}

impl Erc2612SignatureReplayDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("ERC2612 permit signature can be replayed at PC {}", location),
                pc: location,
                confidence: 0.89,
            });
        }
