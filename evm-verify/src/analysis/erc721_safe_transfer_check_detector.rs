/// Erc721 Safe Transfer Check Detector
/// Missing safeTransferFrom check allows stuck NFTs
use crate::bytecode::SecurityFinding;

pub struct Erc721SafeTransferCheckDetector {
    bytecode: Vec<u8>,
}

impl Erc721SafeTransferCheckDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Missing safeTransferFrom check allows stuck NFTs at PC {}", location),
                pc: location,
                confidence: 0.83,
            });
        }
