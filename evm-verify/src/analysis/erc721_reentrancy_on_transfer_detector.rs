/// Erc721 Reentrancy On Transfer Detector
/// ERC721 transfer callback enables reentrancy
use crate::bytecode::SecurityFinding;

pub struct Erc721ReentrancyOnTransferDetector {
    bytecode: Vec<u8>,
}

impl Erc721ReentrancyOnTransferDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("ERC721 transfer callback enables reentrancy at PC {}", location),
                pc: location,
                confidence: 0.9,
            });
        }
