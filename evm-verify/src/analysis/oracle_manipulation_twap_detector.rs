/// Oracle Manipulation Twap Detector
use crate::bytecode::SecurityFinding;

pub struct OracleManipulationTwapDetector {
    bytecode: Vec<u8>,
}

impl OracleManipulationTwapDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("TWAP oracle manipulation at PC {}", location),
                pc: location,
                confidence: 0.87,
            });
        }
