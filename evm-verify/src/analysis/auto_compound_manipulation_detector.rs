/// Auto Compound Manipulation Detector
use crate::bytecode::SecurityFinding;

pub struct AutoCompoundManipulationDetector {
    bytecode: Vec<u8>,
}

impl AutoCompoundManipulationDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_pattern() {
            findings.push(SecurityFinding {
                ...
                description: format!("Auto-compound manipulation at PC {}", location),
                pc: location,
                confidence: 0.84,
            });
        }
