/// Oracle Front Running Detector
use crate::bytecode::SecurityFinding;

pub struct OracleFrontRunningDetector {
    bytecode: Vec<u8>,
}

impl OracleFrontRunningDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Oracle update frontrunning at PC {}", location),
                pc: location,
                confidence: 0.86,
            });
        }
