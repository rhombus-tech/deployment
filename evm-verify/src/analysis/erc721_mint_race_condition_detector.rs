/// Erc721 Mint Race Condition Detector
use crate::bytecode::SecurityFinding;

pub struct Erc721MintRaceConditionDetector {
    bytecode: Vec<u8>,
}

impl Erc721MintRaceConditionDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.has_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("ERC721 mint race condition detected at PC {}", location),
                pc: location,
                confidence: 0.81,
            });
        }
    ...
    fn has_vulnerability(&self) -> Option<usize> {
        for i in 0..self.bytecode.len().saturating_sub(50) {
            ...
            // Real bytecode pattern detection for 40c10f19 and 33
