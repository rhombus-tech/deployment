/// Erc1155 Batch Transfer Detector
/// ERC1155 batch transfer manipulation
use crate::bytecode::SecurityFinding;

pub struct Erc1155BatchTransferDetector {
    bytecode: Vec<u8>,
}

impl Erc1155BatchTransferDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("ERC1155 batch transfer manipulation at PC {}", location),
                pc: location,
                confidence: 0.82,
            });
        }
