/// Function Selector Shadowing Detector
use crate::bytecode::SecurityFinding;

pub struct FunctionSelectorShadowingDetector {
    bytecode: Vec<u8>,
}

impl FunctionSelectorShadowingDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Function selector shadowing in proxy at PC {}", location),
                pc: location,
                confidence: 0.89,
            });
        }
