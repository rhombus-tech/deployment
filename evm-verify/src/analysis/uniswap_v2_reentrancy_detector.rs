/// Uniswap V2 Reentrancy Detector
use crate::bytecode::SecurityFinding;

pub struct UniswapV2ReentrancyDetector {
    bytecode: Vec<u8>,
}

impl UniswapV2ReentrancyDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_pattern() {
            findings.push(SecurityFinding {
                ...
                description: format!("Uniswap V2 reentrancy vulnerability at PC {}", location),
                pc: location,
                confidence: 0.88,
            });
        }
