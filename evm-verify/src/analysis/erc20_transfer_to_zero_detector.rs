/// Erc20 Transfer To Zero Detector
/// Transfer to zero address burns funds permanently
use crate::bytecode::SecurityFinding;

pub struct Erc20TransferToZeroDetector {
    bytecode: Vec<u8>,
}

impl Erc20TransferToZeroDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Transfer to zero address burns funds permanently at PC {}", location),
                pc: location,
                confidence: 0.84,
            });
        }
