/// Hash Collision Attack Detector
use crate::bytecode::SecurityFinding;

pub struct HashCollisionAttackDetector {
    bytecode: Vec<u8>,
}

impl HashCollisionAttackDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.has_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Hash collision vulnerability detected at PC {}", location),
                pc: location,
                confidence: 0.85,
            });
        }
    ...
    fn has_vulnerability(&self) -> Option<usize> {
        for i in 0..self.bytecode.len().saturating_sub(50) {
            ...
            // Real bytecode pattern detection for 20 and 14
