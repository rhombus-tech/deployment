/// Extcodesize During Constructor Detector
/// EXTCODESIZE check bypassed during constructor
use crate::bytecode::SecurityFinding;

pub struct ExtcodesizeDuringConstructorDetector {
    bytecode: Vec<u8>,
}

impl ExtcodesizeDuringConstructorDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("EXTCODESIZE check bypassed during constructor at PC {}", location),
                pc: location,
                confidence: 0.89,
            });
        }
