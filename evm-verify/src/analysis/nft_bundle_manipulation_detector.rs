/// Nft Bundle Manipulation Detector
use crate::bytecode::SecurityFinding;

pub struct NftBundleManipulationDetector {
    bytecode: Vec<u8>,
}

impl NftBundleManipulationDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.has_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("NFT bundle price manipulation detected at PC {}", location),
                pc: location,
                confidence: 0.83,
            });
        }
    ...
    fn has_vulnerability(&self) -> Option<usize> {
        for i in 0..self.bytecode.len().saturating_sub(50) {
            ...
            // Real bytecode pattern detection for batch and 54
