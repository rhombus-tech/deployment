/// Arbitrum Sequencer Manipulation Detector
use crate::bytecode::SecurityFinding;

pub struct ArbitrumSequencerManipulationDetector {
    bytecode: Vec<u8>,
}

impl ArbitrumSequencerManipulationDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_exploit_pattern() {
            findings.push(SecurityFinding {
                ...
                description: format!("Arbitrum sequencer manipulation at PC {}", location),
                pc: location,
                confidence: 0.87,
            });
        }
