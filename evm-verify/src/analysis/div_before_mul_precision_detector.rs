/// Div Before Mul Precision Detector
/// Division before multiplication loses precision
use crate::bytecode::SecurityFinding;

pub struct DivBeforeMulPrecisionDetector {
    bytecode: Vec<u8>,
}

impl DivBeforeMulPrecisionDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Division before multiplication loses precision at PC {}", location),
                pc: location,
                confidence: 0.86,
            });
        }
