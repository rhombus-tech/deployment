/// Erc20 Return Value Detector
/// Unchecked ERC20 return value ignores transfer failures
use crate::bytecode::SecurityFinding;

pub struct Erc20ReturnValueDetector {
    bytecode: Vec<u8>,
}

impl Erc20ReturnValueDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Unchecked ERC20 return value ignores transfer failures at PC {}", location),
                pc: location,
                confidence: 0.87,
            });
        }
