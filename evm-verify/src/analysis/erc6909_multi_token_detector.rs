/// Erc6909 Multi Token Detector
use crate::bytecode::SecurityFinding;

pub struct Erc6909MultiTokenDetector {
    bytecode: Vec<u8>,
}

impl Erc6909MultiTokenDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_exploit_pattern() {
            findings.push(SecurityFinding {
                ...
                description: format!("ERC6909 multi-token vulnerability at PC {}", location),
                pc: location,
                confidence: 0.84,
            });
        }
