/// Token Standard Violation Detector
/// Token standard violation breaks composability
use crate::bytecode::SecurityFinding;

pub struct TokenStandardViolationDetector {
    bytecode: Vec<u8>,
}

impl TokenStandardViolationDetector {
    ...
    pub fn detect(&self) -> Vec<SecurityFinding> {
        ...
        if let Some(location) = self.detect_vulnerability() {
            findings.push(SecurityFinding {
                ...
                description: format!("Token standard violation breaks composability at PC {}", location),
                pc: location,
                confidence: 0.84,
            });
        }
