# HIGH-CONFIDENCE Vulnerability Report - Block 22959215 Transaction 164

## Contract Information
- **Analysis Mode**: High-Confidence Only
- **Protocol**: High-Confidence Analysis
- **Contract Address**: 0xc38e4e6a15593f908255214653d3d947ca1c2338
- **Block Number**: 22959215
- **Transaction Index**: 164
...
- **Description**: Unchecked external call at position 87. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
...
### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 258. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls

### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 762. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls

### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 916. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls
