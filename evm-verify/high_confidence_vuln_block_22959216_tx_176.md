# HIGH-CONFIDENCE Vulnerability Report - Block 22959216 Transaction 176
...
- **Description**: Unchecked external call at position 374. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
