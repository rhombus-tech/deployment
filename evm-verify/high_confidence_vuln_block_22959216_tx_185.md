# HIGH-CONFIDENCE Vulnerability Report - Block 22959216 Transaction 185
...
• External call at PC 21 with HIGH risk profile
• ⚠️  Call transfers ETH value - enables callback with incentive
• ⚠️  1 state changes detected after external call at PCs: [65]
...
- **Description**: Unchecked external call at position 21. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
