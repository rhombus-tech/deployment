...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("\n--- PCC Only Analysis ---");
    let pcc_verifier = UnifiedVerifier::with_config(false, true, VerificationStrategy::Groth16);
    ...
    println!("\n--- PCD Only Analysis ---");
    let pcd_verifier = UnifiedVerifier::with_config(true, false, VerificationStrategy::Groth16);
