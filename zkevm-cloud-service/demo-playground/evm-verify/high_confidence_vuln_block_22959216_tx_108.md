# HIGH-CONFIDENCE Vulnerability Report - Block 22959216 Transaction 108
...
• ⚠️  1 state changes detected after external call at PCs: [156]
...
### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 557. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls

### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 586. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls
