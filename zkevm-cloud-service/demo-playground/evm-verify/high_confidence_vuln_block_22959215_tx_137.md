# HIGH-CONFIDENCE Vulnerability Report - Block 22959215 Transaction 137
...
• ⚠️  1 state changes detected after external call at PCs: [192]
...
### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 188. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls

### UncheckedCall (Severity: Low)
- **Description**: Unchecked external call at position 225. The return value of the call is not checked.
- **Location**: Unknown
- **Confidence**: High (>75%)
- **Recommendation**: Always check return values of external calls
