...
#[tokio::test]
async fn test_unified_verifier() {
    ...
    // Analyze bytecode
    let report = verifier.analyze_bytecode(&bytecode).await.unwrap();
...
#[tokio::test]
async fn test_unified_verifier_with_config() {
...
#[tokio::test]
async fn test_unified_verifier_with_pcd_only() {
