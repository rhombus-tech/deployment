...
fn detect_unpredictable_fuel_consumption(module: &Module, vulnerabilities: &mut Vec<IndexerVulnerability>) {
    ...
    for func in module.funcs.iter() {
        let func_name = func.name().unwrap_or("<unnamed>").to_string();
...
mod tests {
    ...
    #[test]
    fn test_detect_mutual_recursion() -> Result<()> {
    ...
    #[test]
    fn test_detect_non_tail_recursion() -> Result<()> {
